    ...
    return(
         ...
         <StatusBar
           ...
           <TouchableOpacity onPress= {()=>this.props.navigation.goBack()} style={{marginLeft:20,marginTop:25}}>
            ...
            <Text style={{fontSize:16,fontFamily:'AvenirLTStd-Medium',color:'#242327',alignSelf:'center',marginTop:20}}>You owed</Text>
            <Text style={{fontSize:40,fontFamily:'AvenirLTStd-Heavy',color:'#242327',marginTop:5,alignSelf:'center'}}>₹20,000</Text>
            
            

            <Text style={{fontSize:16,fontFamily:'AvenirLTStd-Medium',color:'#242327',alignSelf:'center',marginTop:60}}>Paid</Text>
            ...
            <View style={{flexDirection:'row',alignItems:'center',marginTop:2}}>
             <Text style={{fontSize:15,fontFamily:'AvenirLTStd-Heavy',color:'#FF1A1A'}}>₹250</Text>
            ...
            <View style={{flexDirection:'column',marginLeft:12,width:'54%'}}>
            <Text style={{fontSize:18,fontFamily:'AvenirLTStd-Heavy',color:'white'}}>Paid Karan</Text>
            <Text style={{fontSize:15,fontFamily:'AvenirLTStd-Heavy',color:'#FF1A1A',marginTop:2}}>₹250</Text>
            </View>
