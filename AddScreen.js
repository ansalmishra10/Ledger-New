        ...
        <StatusBar
           ...
           <View style = {{height:60,backgroundColor:'white',flexDirection:'row',width:'100%',alignItems:'center',elevation:3}}>
                    ...
                    <KeyboardAwareScrollView
                       ...
                       <Text style={{fontSize:18,fontFamily:'AvenirLTStd-Heavy',color:'#242327',alignSelf:'center',marginTop:10}}>Upload group photo</Text>
            ...
            <TouchableOpacity style={{height:50,width:'86%',borderRadius:25,marginTop:35,backgroundColor:'#242327',alignSelf:'center',justifyContent:'center',marginBottom:20}}
